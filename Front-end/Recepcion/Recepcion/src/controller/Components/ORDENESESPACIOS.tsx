     ...
     <div className="row w-50  bg-primary border-bottom text-white align-content-center overflow-scroll  " >
      ...
      <div className="row p-3 scrollable" >
        ...
        {clientes.length >= 1 ? clientes.map((items: DeudaClientesEntity) => {
          ...
          return <div className="col-md-4 p-1" onClick={() => { alert(items) }} key={items.idCliente}>
            ...
            <div className="card"  >
              ...
              <div className="card-body">
                ...
                <center><button className='btn btn-primary mt-2' onClick={() => { DETALLESDEUDAS(items.idCliente), alert(detalles) }}> DETALLES</button></center>
              </div>
            </div>
          </div>
        }) : deudas.map((items: DeudaClientesEntity) => {
