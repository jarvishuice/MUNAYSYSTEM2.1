from core.Entities.reports.espacios.reporteEspaciosEntity import DeudaCliente,WalletDisponibles,VentasPorProducto,ReporteEspaciosEntity,DetallePagos,DetallesPedidos,OrdenesAbiertas,VentasPorClientes,PuntoCount
...
class ICierre(ABC):
    ...
    @abstractmethod
    def generarCierre(sede:str)->ReporteEspaciosEntity:
        pass
